...
def train_step(model1: torch.nn.Module, 
    ...
    for batch, (X, y) in enumerate(dataloader):
        ...
        #batch matrix muktiplication using einsum        # weighted_output = weights
    ...
    return vit_train_loss, vit_train_acc
...
def train(model1: torch.nn.Module, 
    ...
    for epoch in tqdm(range(epochs)):
        vit_train_loss, vit_train_acc = train_step(model1=model1,
                                                                                      dataloader=train_dataloader,
                                                                                      loss_fn=loss_fn,
                                                                                      vit_optimizer=vit_optimizer,
                                                                                      device=device,
                                                                                      batch_size=batch_size)
        vit_test_loss, vit_test_acc = test_step(model1=model1,
